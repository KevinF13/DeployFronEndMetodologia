...
export class CentroCostosComponent {
  ...
  fetchCentroCostos(): void {
    ...
    this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/centroCostos', { params }).subscribe(
      data => {
  ...
  guardarNuevoCentroCostos(codigo: string, descripcion: string) {
    if (codigo && descripcion) {
      const url = `https://apimetodologias.azurewebsites.net/api/Api/centroCostos/insert?codigoCentroCostos=${codigo}&descripcionCentroCostos=${descripcion}`;
  ...
  guardarCambiosCentroCostos(codigo: number, nombre: string): void {
    const url = `https://apimetodologias.azurewebsites.net/api/Api/centroCostos/update?codigoCentroCostos=${codigo}&descripcionCentroCostos=${nombre}`;
  ...
  eliminarCentroCostos(codigo: number, descripcion: string) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.http.delete('https://apimetodologias.azurewebsites.net/api/Api/centroCostos/delete', { params }).subscribe(
          result => {
            console.log(result);
  ...
  searchCentroCostos() {
    ...
    this.http.get<any[]>(`https://apimetodologias.azurewebsites.net/api/Api/centroCostos/search?descripcioncentrocostos=${descripcion}`).subscribe(
      (data) => {
