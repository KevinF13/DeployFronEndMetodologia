...
export class MovimientoPlanillaComponent {
  ...
  ngOnInit(): void {
    ...
    this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/MovimientosExcepcion1y2')
    .pipe(
    ...
    .subscribe(
      ...
      this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/ObtenerMovimientosExcepcion3')
      .pipe(
        map(data => data.map(item => ({
          value: item.DesripMovimientoExce, // Usar DesripMovimientoExce como valor
          label: item.CodigoMovimientoExce // Mostrar CodigoMovimientoExce en la interfaz
      ...
      this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/GetTipoOperacion')
      .pipe(
        map(data => data.map(item => ({
      ...
      this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/GetTrabaAfectaIESS')
      .pipe(
        map(data => data.map(item => ({
          value: item.DesripMovimientoExce, // Usar DesripMovimientoExce como valor
          label: item.CodigoMovimientoExce // Mostrar CodigoMovimientoExce en la interfaz
      ...
      this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/GetTrabAfecImpuestoRenta')
      .pipe(
        map(data => data.map(item => ({
          value: item.DesripMovimientoExce, // Usar DesripMovimientoExce como valor
          label: item.CodigoMovimientoExce // Mostrar CodigoMovimientoExce en la interfaz
  ...
  fetchMovimientosPlanilla(): void {
    ...
    this.http.get<any[]>('https://apimetodologias.azurewebsites.net/api/Api/movimientosPlanilla', { params }).subscribe(
      data => {
  ...
  guardarCambiosMovimientoPlanilla(codigoPlanilla: number, conceptos: string, prioridad: number, tipooperacion: string
    ...
    const url = `https://apimetodologias.azurewebsites.net/api/Api/movimientosPlanilla/update?codigoplanilla=${codigoPlanilla}&conceptos=${conceptos}&prioridad=${prioridad}&tipooperacion=${tipooperacion}&cuenta1=${cuenta1}&cuenta2=${cuenta2}&cuenta3=${cuenta3}&cuenta4=${cuenta4}&MovimientoExcepcion1=${MovimientoExcepcion1}&MovimientoExcepcion2=${MovimientoExcepcion2}&MovimientoExcepcion3=${MovimientoExcepcion3}&Traba_Aplica_iess=${Traba_Aplica_iess}&Traba_Proyecto_imp_renta=${Traba_Proyecto_imp_renta}&Aplica_Proy_Renta=${Aplica_Proy_Renta}&Empresa_Afecta_Iess=${Empresa_Afecta_Iess}`;
    this.http.get(url).subscribe(
      (response) => {
    ...
    eliminarMovimientoPlanilla(codigo: number, descripcion: string) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.http.get('https://apimetodologias.azurewebsites.net/api/Api/movimientosPlanilla/delete', { params }).subscribe(
            result => {
              // console.log(result);
    ...
    searchMovimientoPlanilla() {
      ...
      this.http.get<any[]>(`https://apimetodologias.azurewebsites.net/api/Api/movimientosPlanilla/search?concepto=${concepto}`).subscribe(
        (data) => {
